    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-6 py-16 relative">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-6xl md:text-7xl font-bold mb-8 text-white font-playfair leading-tight">
              Welcome to NUIB
            </h1>
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block bg-white text-nuib-navy px-10 py-4 rounded-md hover:bg-opacity-90 transition duration-300 text-lg"
            >
              Learn More
            </motion.a>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-24">
            {[
              ...
              <AnimateOnScroll key={feature.title} delay={index * 0.2}>
                <div className="bg-white/10 backdrop-blur-sm p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-white/10 hover:bg-white/20">
                  <h2 className="text-2xl font-semibold mb-6 text-white font-playfair">
                    {feature.title}
                  </h2>
          ...
          <AnimateOnScroll>
            <div className="bg-white/10 backdrop-blur-sm p-12 rounded-lg text-center transform hover:scale-[1.02] transition-all duration-300 border border-white/10 hover:bg-white/20">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 font-playfair text-white">Join Our Community</h2>
              ...
              <motion.a 
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-block bg-white text-nuib-navy px-10 py-4 rounded-md hover:bg-opacity-90 transition duration-300 text-lg font-medium"
              >
                Get Started
              </motion.a>
            </div>
